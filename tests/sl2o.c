...
TEST multiplication_associativity(void) {
  ...
  for (i = 0; i < 1024; i++) {
    ...
    sl2_rand(b);
    sl2_rand(c);
    sl2_mul_optimized(d, a, b);
    sl2_mul_optimized(d, d, c);
    sl2_mul_optimized(e, b, c);
    sl2_mul_optimized(e, a, e);
